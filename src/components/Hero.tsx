...
const Hero = () => {
  ...
  const translations = {
    ...
    ar: {
      headline: 'جمال راقٍ. عناية بلا عناء.',
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-pure-white/90 via-pearl/85 to-pure-white/90"></div>
      </div>
      
      {/* Content */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="fade-in">
          <h1 className={`text-5xl md:text-7xl lg:text-8xl font-playfair font-bold text-charcoal mb-6 leading-tight ${isRTL ? 'font-arabic' : ''}`}>
            {t.headline}
          </h1>
